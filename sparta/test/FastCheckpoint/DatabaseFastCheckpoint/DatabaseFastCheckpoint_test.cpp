...
using sparta::serialization::checkpoint::DatabaseFastCheckpointer;
...
void generalTest()
{
    ...
    // Setup...
    app_mgr.getAppFactory<DatabaseFastCheckpointer>()->setSpartaElems(root, &sched);
    app_mgr.enableApp(DatabaseFastCheckpointer::NAME);
    app_mgr.createEnabledApps();
    app_mgr.postInit(0, nullptr);
    app_mgr.openPipelines();

    auto& dbcp = *app_mgr.getApp<DatabaseFastCheckpointer>();
    ...
    // CHECKPOINT: HEAD
    DatabaseFastCheckpointer::chkpt_id_t head_id;
    ...
    std::vector<DatabaseFastCheckpointer::chkpt_id_t> chkpt_ids;
    ...
    for (uint32_t i = 1; i <= 10000; ++i) {
        ...
        DatabaseFastCheckpointer::chkpt_id_t id;
